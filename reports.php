    ...
    <div style="padding: 16px 0;">
      ...
      <?php else: ?>
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px;">
          <div class="stat-card stat-card-blue" style="padding: 12px;">
            <div class="stat-value" style="font-size: 1.5rem;"><?php echo $taskStats['total']; ?></div>
            <div class="stat-label">Total Tasks</div>
          </div>
          <div class="stat-card stat-card-green" style="padding: 12px;">
            <div class="stat-value" style="font-size: 1.5rem;"><?php echo $taskStats['completed']; ?></div>
            <div class="stat-label">Completed</div>
          </div>
          <div class="stat-card stat-card-yellow" style="padding: 12px;">
            <div class="stat-value" style="font-size: 1.5rem;"><?php echo $taskStats['in_progress']; ?></div>
            <div class="stat-label">In Progress</div>
          </div>
          <div class="stat-card stat-card-info" style="padding: 12px;">
            <div class="stat-value" style="font-size: 1.5rem;"><?php echo $taskStats['pending']; ?></div>
            <div class="stat-label">Pending</div>
          </div>
        </div>
